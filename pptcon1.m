function [nstns,S,P]=pptcon1
%
% convert a lofgren-style file of multiple monthly ppt series
...
%
% * Data filenames
% Prefix from leading header line, plus "p", suffix .mat
%  Example *tucsonu -->  tucsonup.mat
%			*ajo --> ajop.mat
%
...
file1=uigetfile('*.dat','Input Lofgren-style PPT file');
fid1=fopen(file1,'r')
frewind(fid1)
