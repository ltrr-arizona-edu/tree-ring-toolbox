function [I2,stats,c,e,yhat]=stepr1(X,y,I1)

%  stepr.m  stepwise regression  

% D. Meko,  10-6-91;  rev:  3-18-92
...
% If only one potential predictor, and equation gives adjusted R-sq
%		less than zero, returns [] [0 0 0] [0 0] [y] [].  In other
%		words, a null equation is accepted, and residuals are set equal to y.
