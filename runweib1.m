function runweib1
% runweib1: Index drought summary of reconstruction simulations vs actual 
% CALL: runweib1;
%
...
errorbar((1:highx),Smed(1:highx),LO(1:highx),HI(1:highx));
hold on
plot((1:highx)',skey(1:highx),'.','MarkerSize',22); % max severity for observed data
plot((1:highx),Smed(1:highx),'o','MarkerSize',12); % median of max severity for
%       the 1000 simulations
title1='Most Severe Droughts for Various Run Lengths';
title2=[int2str(nS) ' Simulations']
title({title1,title2});
xlabel('Duration (yr)','FontSize',14);
ylabel('Severity (mm )','FontSize',14);
