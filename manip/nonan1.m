...
% nonan: find longest block of continuous years with no missing data in a time series mtx
% [yrgo2,yrsp2]=nonan1(X,yr);
% Last revised: 7-12-99
%
% Finds the longest continuous block of a time series matrix for which none of the
% series has any missing (NaN) data. Useful in selecting period for calibration of
