function treecpy1
% treecpy1: copy tree-ring toolbox functions to a single directory
% treecpy;
% Last revised 5-6-99
%
% treecpy1.m is needed to gather tree-ring toolbox functions from various 
% subdirectories under \mlb\ into a single directory. Used to facilitate 
% gathering the functions for distribution to users
%
%*** INPUT -- no arguments
%
...
[file1,path1]=uigetfile('c:\manip\toolfls.txt','Input file of names of functions to copy');
pf1=[path1 file1];
