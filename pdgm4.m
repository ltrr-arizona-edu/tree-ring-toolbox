...
% on the smoothed periodogram.  Modified from pdgm2.m to give a 
% 4-frame plot of spectra for four different time series.  This
% pgm is for estimated spectra only.  No confidence bands, no null
% continuum, no inset smoothing window.  
%
% Specifically altered to generate Figure AB3-4.
%
% Version 1.1, 10/90, by David M. Meko, Laboratory of
