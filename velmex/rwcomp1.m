function rwcomp1
% rwcomp1: compare a pair of measured ring-width series from the same rwmeas measurement file
% rwcomp1;
% Last revised 5-16-03
%
% compare a pair of measured ring-width series from the same rwmeas measurement file
%
%*** INPUT
%
% No input arguments.
