...
clc;
disp(['Starting Cross-validation seasonal MLR']);
...
while k2wh==1;  % Stay in plot loop
   ...
   elseif k2men==6; % Point & click to view climate PCs
   ...
   elseif k2men==7; % toggle keyboard mode
      if strcmp(kboard,'Yes');
         kboard='No';
      else;
         kboard='Yes';
