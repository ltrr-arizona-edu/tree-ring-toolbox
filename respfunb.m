function respfunb(fwind,dlab,mlab,wgt,L,A,C,kopt)
%

To be edited into function similar to respfuna.m, but to graphically summarize 
autocorrelation in tree-ring series and climate series
