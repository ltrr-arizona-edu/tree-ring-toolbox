function grplot1a(selvec)
% grplot1a:  multi series plots of ring-width series
% USAGE : gprlot1a(selvec,filelist)
...
ButtonName=questdlg('Multi-file run using a filelist?');
switch ButtonName
case 'No'
   filelist=0;
case 'Cancel';
...
% filelist is now set to 1 if will be using file list
