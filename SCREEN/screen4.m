...
% Screen3.m called oesplit1.m, which used split-sample calibration-
% validation to get statistics on various models and pick a
% best model.  If 
% you set O(1)==2 in running screen3.m and ran the model 
% on a particular chronology, you got a .mat file with these 
% variables, which must be in the workspace to run screen4.m:
%
...
plot(yr,y2+mn3(1),yr,yh+mn3(1),'--',...
[yr(1) yr(nyrs)],[mn3(1) mn3(1)],'w-')
