...
while kwh1;
    ...
    if kmen1==1; 
        ...
        vbl1='XEL';
         ...
         uiwait(msgbox('First mode only mode implemented so far','Click again!','modal'));
    end;
end;
    ...
    if kmen2==2; 
        ...
        while kwh2==1;
            ...
            if sum(Lwinner)~=1;
                ...
                % Compute stats
                zmean =[nanmean(x1) nanmean(x2)]; % means of computed, measured total
                ...
                a2=x2(L2);
                yra2=yrx2(L2);
                d = [a2 - a1]; % difference measured minus computed
