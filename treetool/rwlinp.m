...
%   1. line 8 of the first line in the file contains "1", col
...
%	Col 1-8:  Core ID strings. 
%	Col 9-12:  Year (decade)
...
% Whether or not 3 header lines (ihead==1 vs ihead==0)
